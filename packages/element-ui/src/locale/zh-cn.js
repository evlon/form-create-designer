const ZhCn = {
    ...
    com: {
        ...
        fcDynamicRender: {
            name: 'Vue组件',
            info: '支持Vue单文件组件格式，包含template、script、style三个部分',
            props: {
                vueContent: '完整的Vue SFC代码内容',
                formCreateInject: 'form-create注入的数据'
            },
            event: {
                mounted: '组件挂载后触发',
                error: '组件渲染错误时触发'
        ...
        audioBox: {
            notSupported: '您的浏览器不支持 audio 标签',
            noAudio: '暂无音频',
            selectAudio: '选择音频',
            unknownTrack: '未知曲目'
        },
        FcCity: {
            ...
            event: {
                change: '选择变化时触发',
                'expand-change': '面板展开时触发',
                blur: '失去焦点时触发',
                focus: '获得焦点时触发',
                'visible-change': '可见性变化时触发'
            }
        },
        FcAiPanel: {
            name: 'AI 助手',
            info: 'AI 驱动的聊天助手，用于生成表单',
            props: {
                title: '标题',
                disabled: '禁用',
                showHeader: '显示头部',
        ...
        globalFetchConfig: {
            ...
            method: '方式',
            headers: '请求头',
            urlPlaceholder: 'API 接口地址',
            headersPlaceholder: 'JSON 格式的请求头',
            test: '测试',
            result: '结果',
            empty: '未配置全局 API 接口'
        },
        GlobalFetchConfig: {
            name: '全局 API 接口',
            info: '配置全局 API 接口用于数据获取'
        },
        DataView: {
            name: '数据视图',
            info: '以多种视图模式展示数据（列表、卡片、统计）',
            props: {
                title: '标题',
                disabled: '禁用',
                showHeader: '显示头部',
        ...
        NestedTableForm: {
            ...
            event: {
                ...
                delete: '删除行时触发',
                'add-child': '添加子行时触发',
                'delete-child': '删除子行时触发',
                'expand-change': '展开状态变化时触发',
                'selection-change': '选择变化时触发'
            }
        },
        nestedTableForm: {
        ...
        aiTool: {
            ...
            maxTokens: '最大令牌数',
            systemPrompt: '系统提示词',
            systemPromptPlaceholder: '请输入 AI 的系统提示词',
            quickActions: '快捷操作',
            tools: '工具',
            toolGenerateForm: '生成表单',
            toolGenerateRule: '生成规则',
            toolOptimizePrompt: '优化提示词',
            toolTranslate: '翻译',
            toolExplainField: '解释字段',
            actionGenerateForm: '生成表单',
            actionOptimize: '优化',
            actionTranslate: '翻译',
            actionExplain: '解释',
            saveConfig: '保存',
        ...
        globalEventConfig: {
            ...
            intervalMs: '间隔时间(ms)',
            targetFields: '目标字段',
            targetsPlaceholder: '选择目标字段',
            condition: '触发条件',
            conditionPlaceholder: '输入条件表达式',
            actions: '执行动作',
            actionValuePlaceholder: '输入动作值',
            addAction: '添加动作',
            noEvents: '暂无事件配置'
        },
        MStepForm: {
        ...
        infiniteTableFormView: {
            ...
            actions: '操作',
            addRow: '添加行',
            dataCount: '显示 {visible} / 共 {total} 条',
            rowAdded: '已添加行',
            rowDeleted: '已删除行'
        },
        NestedTableFormView: {
